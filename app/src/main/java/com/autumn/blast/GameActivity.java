...
public class GameActivity extends Activity {
    ...
    void SCALE() {
        ...
        // text mess
        ((TextView) findViewById(R.id.mess)).setTextSize(TypedValue.COMPLEX_UNIT_PX, DpToPx(40));
    }
    ...
    void START() {
        ...
        findViewById(R.id.mess).setAlpha(1);
        current_section = R.id.mess;
    ...
    Runnable TIMER = new Runnable() {
        ...
        public void run() {
            ...
            // show time message
            ((TextView) findViewById(R.id.mess)).setText(R.string.time_up);
            findViewById(R.id.mess).setVisibility(View.VISIBLE);
            findViewById(R.id.mess).setAlpha(0.7f);
